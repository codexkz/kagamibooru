`kagamibooru` uses REST API for all operations.
...
To prevent problems with concurrent resource modification, kagamibooru
...
true even if the way the snapshots are generated changes - kagamibooru stores
