...
from kagamibooru import api, config, db, errors, middleware, rest
from kagamibooru.func.file_uploads import purge_old_uploads
from kagamibooru.func.posts import (
...
def validate_config() -> None:
    ...
    lethal at runtime.
    """
    from kagamibooru.func.auth import RANK_MAP
