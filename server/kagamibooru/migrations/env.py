...
# fmt: off
# make kagamibooru module importable
dir_to_self = os.path.dirname(os.path.realpath(__file__))
sys.path.append(os.path.join(dir_to_self, *[os.pardir] * 2))

import kagamibooru.config  # noqa: E402
import kagamibooru.model.base  # noqa: E402
# fmt: on
...
szuru_config = kagamibooru.config.config
alembic_config.set_main_option("sqlalchemy.url", szuru_config["database"])

target_metadata = kagamibooru.model.Base.metadata
