...
from kagamibooru.func import auth, user_tokens, users
from kagamibooru.middleware import authenticator
...
def test_process_request_bump_login(context_factory, user_factory):
    ...
    with patch("kagamibooru.func.auth.is_valid_password"), patch(
...
def test_process_request_bump_login_with_token(
    ...
    with patch("kagamibooru.func.auth.is_valid_token"), patch(
        "kagamibooru.func.users.get_user_by_name"
    ), patch("kagamibooru.func.user_tokens.get_by_user_and_token"):
