...
def test_creating_category(
    ...
    with patch("kagamibooru.func.pool_categories.create_category"), patch(
        "kagamibooru.func.pool_categories.serialize_category"
    ), patch("kagamibooru.func.pool_categories.update_category_name"), patch(
