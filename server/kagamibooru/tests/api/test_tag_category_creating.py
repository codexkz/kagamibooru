...
def test_creating_category(
    ...
    with patch("kagamibooru.func.tag_categories.create_category"), patch(
        "kagamibooru.func.tag_categories.serialize_category"
    ), patch("kagamibooru.func.tag_categories.update_category_name"), patch(
