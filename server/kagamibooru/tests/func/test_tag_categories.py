...
from kagamibooru.func import cache, tag_categories
...
def test_create_category_when_first():
    with patch("kagamibooru.func.tag_categories.update_category_name"), patch(
        "kagamibooru.func.tag_categories.update_category_color"
    ), patch("kagamibooru.func.tag_categories.update_category_order"):
...
def test_get_default_category():
    with patch("kagamibooru.func.tag_categories.try_get_default_category"):
